...
/// </para>
/// <para>
/// The controller uses AutoMapper to convert between entities and DTOs, ensuring separation
/// of concerns and protecting internal domain models from external API contracts.
/// </para>
/// <para>
...
/// <example>
/// <code>
/// // Example: Creating a Products API controller
/// [Route("api/products")]
    ...
    where TRepository : IRepository<TEntity, TKey>
{
    ...
    public virtual async Task<ActionResult<TDto>> Update(TKey id, [FromBody] TUpdateDto updateDto)
    {
        ...
        /// <see cref="Data.Advanced.Auditing.IDeletable{T}"/>, a soft delete is performed
