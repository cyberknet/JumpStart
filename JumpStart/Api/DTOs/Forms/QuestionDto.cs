...
/// </summary>
/// <remarks>
/// For choice questions, use the <see cref="JumpStart.Api.DTOs.Forms.QuestionOptionDto"/> list in <c>Options</c>.
/// See also: <see cref="JumpStart.Api.DTOs.Forms.FormWithQuestionsDto"/>
/// </remarks>
/// <example>
/// <code>
/// // Example: Creating a choice question with options
/// var question = new JumpStart.Api.DTOs.Forms.QuestionDto
/// {
///     Id = Guid.NewGuid(),
