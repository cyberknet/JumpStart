...
Welcome to the JumpStart API reference documentation with detailed information about all public types, methods, and properties.
...
- **[JumpStart.Api.Controllers](JumpStart.Api.Controllers.html)** - Base controller classes
- **[JumpStart.Api.DTOs](JumpStart.Api.DTOs.html)** - Data transfer objects
- **[JumpStart.Api.Clients](JumpStart.Api.Clients.html)** - Type-safe API clients
- **[JumpStart.Api.Mapping](JumpStart.Api.Mapping.html)** - AutoMapper profiles

### Services & Configuration

- **[JumpStart.Services.Authentication](JumpStart.Services.Authentication.html)** - JWT authentication
- **[JumpStart.Extensions](JumpStart.Extensions.html)** - Configuration options
- **[Microsoft.Extensions.DependencyInjection](Microsoft.Extensions.DependencyInjection.html)** - DI extensions
