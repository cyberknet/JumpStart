...
/// - <see cref="JumpStart.Api.DTOs.IUpdateDto{TKey}"/> - For update (PUT) operations (includes Id)
...
/// - <see cref="JumpStart.Api.DTOs.Advanced.AuditableEntityDto{TKey}"/> - For entities with audit tracking
/// </para>
/// <para>
