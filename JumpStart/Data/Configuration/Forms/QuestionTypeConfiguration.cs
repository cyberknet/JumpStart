...
/// <summary>
/// Entity Framework Core configuration for <see cref="JumpStart.Forms.QuestionType"/> including seed data.
/// </summary>
/// <remarks>
/// <para>
/// This configuration:
/// - Defines database schema constraints (unique index, display order index)
/// - Seeds default question types required by the Forms module
/// - Ensures consistent data across all environments
/// </para>
/// <para>
/// <strong>Note:</strong> Indexes and seed data cannot be configured with DataAnnotations and must use the Fluent API.
/// </para>
/// <para>
...
/// <example>
/// <code>
/// // Example: Registering QuestionTypeConfiguration in your DbContext
/// protected override void OnModelCreating(Microsoft.EntityFrameworkCore.ModelBuilder modelBuilder)
/// {
///     modelBuilder.ApplyConfiguration(new JumpStart.Data.Configuration.Forms.QuestionTypeConfiguration());
/// }
/// </code>
/// </example>
internal class QuestionTypeConfiguration : IEntityTypeConfiguration<QuestionType>
{
    ...
    {
        // Indexes are now configured via [Index] attributes on the entity class (EF Core 10+).
