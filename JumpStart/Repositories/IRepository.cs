...
/// The entity type that implements <see cref="IEntity"/>. Must be a reference type (class).
/// </typeparam>
/// <remarks>
/// <para>
/// <strong>Key Features:</strong>
/// - Type-safe CRUD operations
/// - Automatic soft-delete support for entities implementing <see cref="Data.Auditing.IDeletable"/>
...
///     Task&lt;IEnumerable&lt;Product&gt;&gt; SearchByNameAsync(Guid searchTerm);
/// }
/// 
...
public interface IRepository<TEntity> where TEntity : class, IEntity
{
    ...
    /// <see cref="Data.Auditing.IDeletable"/>. Only entities where DeletedOn is null will be returned.
    /// </para>
    /// <para>
    ...
    /// <para>
    /// <strong>Soft Delete Behavior:</strong>
    /// Automatically excludes soft-deleted entities if the entity implements <see cref="Data.Auditing.IDeletable"/>.
    /// </para>
    /// <para>
    ...
    /// <para>
    /// <strong>Audit Tracking:</strong>
    /// If the entity implements <see cref="Data.Auditing.IModifiable"/>, the implementation should
    ...
    /// The behavior of this method depends on whether the entity implements <see cref="Data.Auditing.IDeletable"/>:
    /// </para>
    /// <para>
